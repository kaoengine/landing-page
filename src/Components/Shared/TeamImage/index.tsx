...
const square = { width: 400,
                 height: 400,
                }

const segmentStyle = { ...square,
                        overflow: 'hidden',
                        position: 'relative'
                }
...
export const TeamImage: FunctionComponent<TeamImageProps> = ({ infor }) => {
  ...
  return (
    ...
    {isHover && <div className="team-infor"style={square}><Section2r  header={infor.name} subHeader={infor.jobTitle} component={TeamSocialIconList} /></div>}
    </Segment>
  </div>
	)
};